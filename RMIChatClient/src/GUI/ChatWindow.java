...
public class ChatWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        privateMessageList = new javax.swing.JList<String>();
        ...
        SenderLabel.setBackground(new java.awt.Color(255, 255, 0));
        SenderLabel.setText("Sender:");
        SenderLabel.setOpaque(true);

        SenderField.setEditable(false);

        RecipientLabel.setBackground(new java.awt.Color(0, 255, 255));
        RecipientLabel.setText("Recipient:");
        RecipientLabel.setOpaque(true);
